...
import AddProjectDialogue from 'client/views/dialogues/admin/add-project-dialogue';
...
class AdminNavigator {
  ...
  async showAddProjectDialogue() {
    await this.dialogueManager.showDialogue(AddProjectDialogue);
  }
